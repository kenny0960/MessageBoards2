			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<form action="<?php echo URL('admin/comments/' . $comment->id) ?>" method="POST">
						...
						<input type="hidden" name="message_id" value="<?php echo $comment->message_id ?>">
						Nickname (*)<input type="text" name="nickname" class="form-control" required="required"
										   value="<?php echo $comment->nickname ?>">
						<br>
						Email
						...
						Content (*)
                            <textarea name="content" rows="10" class="form-control"
									  required="required"><?php echo $comment->content ?></textarea>
						<br>
						<button class="btn btn-lg btn-info">UPDATE</button>
						<a class="btn btn-lg btn-info" href="<?php echo URL('admin/comments') ?>">Go Back</a>
					</form>
